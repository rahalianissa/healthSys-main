    ...
    <div class="col-md-10 mx-auto">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                @if($unreadCount > 0)
                    <form action="{{ route('patient.notifications.mark-all') }}" method="POST">
                        @csrf
                        ...
                        <div class="notification-card p-3 {{ $isUnread ? 'unread' : '' }} border-bottom">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="d-flex gap-2">
                                    @if($isUnread)
                                        <form action="{{ route('patient.notifications.mark-read', $notification->id) }}" method="POST" class="d-inline">
                                            @csrf
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <div class="empty-state">
                        ...
                        <p class="text-muted small">Vous serez notifié lors de vos activités</p>
                    </div>
                </div>
            </div>
        @endif
