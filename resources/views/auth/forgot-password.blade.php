...
<head>
    ...
    <title>{{ config('app.name', 'HealthSys') }} - Mot de passe oublié</title>
        ...
        <div class="glass-card rounded-3xl shadow-2xl p-8 md:p-10">
            ...
            <div class="text-center mb-8">
                <div class="w-16 h-16 bg-medical-bg rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-lock text-medical-primary text-2xl"></i>
                </div>
                <h2 class="text-2xl font-bold text-medical-dark">Mot de passe oublié ?</h2>
